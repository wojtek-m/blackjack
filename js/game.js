...
// jQuery
$('#deal').on('click', function() { blackjack.deal() });
$('#hit').on('click', function() { blackjack.hit()});
$('#stand').on('click', function() { blackjack.stand()});
$('#rules').on('click', function() { $('#rulesList').toggle() });
$('#rulesList').on('click', function() { $('#rulesList').toggle()});
